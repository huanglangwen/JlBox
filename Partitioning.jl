function Partition!(y::Array{Float64,1},dy_dt::Array{Float64,1},dy_dt_gas_matrix::Array{Float64,2},C_g_i_t::Array{Float64,1},
    ...
    dy_dt_gas_matrix_sum=zeros(Float64,num_reactants_condensed)
    ...
    dy_dt[1:num_reactants]=dy_dt[1:num_reactants].-dy_dt_gas_matrix_sum#sum(dy_dt_gas_matrix,dims=2)
